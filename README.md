...
| CPU hardening and stack guards | In progress | `v0.16.3`; CPUID-gated EFER.NXE, CR0.WP, SMEP, SMAP, and UMIP policy is host-tested and QEMU-smoked with redacted `cpu-hardening` booleans; stack guard evidence is still remaining release work. |
...
| Area | Status | Target |
| --- | --- | --- |
| CPU hardening and stack guards | In progress | `v0.16.3`; finish guard-page-backed activation stack evidence and final release gates. |
