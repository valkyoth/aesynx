...
`v0.26.0` is the current kernel service queue candidate.
...
```bash
cargo xtask release-ready v0.26.0
```
...
- [v0.26.0 Release Candidate Notes](docs/releases/v0.26.0-rc.md)
