...
`v0.28.0` is the current cooperative executor candidate.
...
| Cooperative executor | Active candidate | `v0.28.0`; local cooperative executor, deterministic round-robin dispatch, yield, timer sleep/wake, linear task ownership preservation, and QEMU `[TEST] cooperative-sched=ok`. |
...
```bash
cargo xtask release-ready v0.28.0
```
...
- [v0.28.0 Release Candidate Notes](docs/releases/v0.28.0-rc.md)
