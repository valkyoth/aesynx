...
map/protect/unmap, typed root-table identity, permission lookup, contiguous
range lookup, permission change, unmapped range checks, read-only mapping
visit, checked status accounting, checked byte-range
