...
verification, page-presence checks, mapped-range checks, redacted mapping
summaries, translate, unmap, consistency audit, empty-table reclamation, and
