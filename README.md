...
non-executable range checks, executable range checks, no-executable
...
redacted mapping summaries, translate, unmap, consistency audit,
empty-table reclamation, and explicit TLB flush
