...
contiguous range lookup, permission change, audit-backed unmapped/mapped range
checks, read-only mapping visit, checked status accounting, checked byte-range
