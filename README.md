...
| Kernel-owned address space | In progress | `v0.16.2`; audited mapper state now exports to a redacted x86_64 hardware-shaped page-table image and QEMU requires `hardware_image_ok=true`; the actual CR3 switch is still remaining release work. |
...
| Area | Status | Target |
| --- | --- | --- |
| Kernel-owned address space | In progress | `v0.16.2`; finish real page-table frame allocation, CR3 load, and post-switch smoke evidence. |
