...
use smoke::{
    ...
    PAGE_TABLE_FAIL_MARKER, PAGE_TABLE_LOOKUP_MARKER, PAGE_TABLE_MARKER, PAGE_TABLE_PROTECT_MARKER,
    ...
    PAGE_TABLE_VISIT_MARKER, PANIC_DIAGNOSTIC_MARKER, PANIC_MARKER, PANIC_REGISTERS_MARKER,
