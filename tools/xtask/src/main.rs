...
fn print_help() {
    ...
    println!("  image                                create v0.13 Limine QEMU boot image");
    println!("  qemu                                 run v0.13 QEMU boot smoke");
    println!("  qemu --panic-smoke                   run v0.13 QEMU panic diagnostics smoke");
    println!("  qemu --exception-smoke               run v0.13 QEMU exception smoke");
    println!("  qemu --timer-smoke                   run v0.13 QEMU timer/sleep smoke");
