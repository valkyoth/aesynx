use super::smoke::{
    ...
    PAGING_POLICY_MODEL_HARDWARE_ARENA_MARKER, PAGING_POLICY_MODEL_HARDWARE_IMAGE_MARKER,
    PAGING_POLICY_MODEL_HARDWARE_ROOT_MARKER, PAGING_POLICY_MODEL_HEAP_RESERVED_MARKER,
