use super::smoke::{
    ...
    PAGING_POLICY_FAIL_MARKER, PAGING_POLICY_GUARD_PAGE_MARKER, PAGING_POLICY_HEAP_RESERVED_MARKER,
    PAGING_POLICY_MARKER, PAGING_POLICY_NULL_PAGE_MARKER, PAGING_POLICY_RODATA_READ_ONLY_MARKER,
...
fn qemu_markers_track_v0_16_contracts() {
    ...
    assert_eq!(PAGING_POLICY_TEXT_RX_MARKER, "text_rx_ok=true");
    assert_eq!(
        PAGING_POLICY_RODATA_READ_ONLY_MARKER,
        "rodata_read_only_ok=true"
    );
    assert_eq!(PAGING_POLICY_DATA_RW_NX_MARKER, "data_rw_nx_ok=true");
    assert_eq!(PAGING_POLICY_HEAP_RESERVED_MARKER, "heap_reserved_ok=true");
    assert_eq!(PAGING_POLICY_GUARD_PAGE_MARKER, "guard_page_ok=true");
    assert_eq!(PAGING_POLICY_NULL_PAGE_MARKER, "null_page_ok=true");
    assert_eq!(
