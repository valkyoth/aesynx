use super::{
    ...
    KERNEL_PROFILE, KERNEL_TARGET, PAGE_FAULT_MARKER, PANIC_DIAGNOSTIC_MARKER, PANIC_MARKER,
    PANIC_REGISTERS_MARKER, SERIAL_MARKER, SmokeKind, parse_qemu_args,
};

#[test]
fn qemu_markers_track_v0_9_contracts() {
    ...
    assert_eq!(FAULT_ADDRESS_MARKER, "cr2=0x");
