...
use super::smoke::{
    BOOTINFO_MARKER, CPU_SETUP_MARKER, EXCEPTION_MARKER, EXCEPTION_SETUP_MARKER,
    FAULT_ADDRESS_MARKER, FAULT_ADDRESS_PRESENT_MARKER, FAULT_CR3_MARKER,
    ...
    PAGE_TABLE_AUDIT_MARKER, PAGE_TABLE_EXECUTABLE_RANGE_MARKER, PAGE_TABLE_FLAGS_MARKER,
    PAGE_TABLE_KERNEL_ONLY_MARKER, PAGE_TABLE_KERNEL_RANGE_MARKER, PAGE_TABLE_LOOKUP_MARKER,
    PAGE_TABLE_MAPPED_RANGE_MARKER, PAGE_TABLE_MARKER, PAGE_TABLE_NO_DEVICE_MARKER,
    PAGE_TABLE_NO_EXECUTABLE_MARKER, PAGE_TABLE_NO_GLOBAL_MARKER, PAGE_TABLE_NO_WRITABLE_MARKER,
    ...
    PAGE_TABLE_RANGE_LOOKUP_MARKER, PAGE_TABLE_RANGE_MARKER, PAGE_TABLE_RECLAIM_MARKER,
    PAGE_TABLE_STATUS_MARKER, PAGE_TABLE_UNMAPPED_RANGE_MARKER, PAGE_TABLE_USER_RANGE_MARKER,
    PAGE_TABLE_VISIT_MARKER, PAGE_TABLE_WRITE_PROTECTED_RANGE_MARKER, PANIC_MARKER, SERIAL_MARKER,
    SLEEP_MARKER, SmokeKind, TIMER_DELAYED_LOG_MARKER, TIMER_MARKER, TIMER_SETUP_MARKER,
