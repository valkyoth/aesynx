...
use super::smoke::{
    ...
    PAGE_TABLE_WRITE_PROTECTED_RANGE_MARKER, PAGING_POLICY_DATA_RW_NX_MARKER,
    PAGING_POLICY_GUARD_PAGE_MARKER, PAGING_POLICY_HEAP_RESERVED_MARKER, PAGING_POLICY_MARKER,
    PAGING_POLICY_NULL_PAGE_MARKER, PAGING_POLICY_RODATA_READ_ONLY_MARKER,
    PAGING_POLICY_SECTION_LAYOUT_MARKER, PAGING_POLICY_STATUS_MARKER, PAGING_POLICY_TEXT_RX_MARKER,
