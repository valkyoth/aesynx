...
use super::smoke::{
    ...
    MEMORY_TOTAL_MARKER, MEMORY_USABLE_MARKER, MULTICORE_TOPOLOGY_AP_EXECUTION_BLOCKED_MARKER,
    MULTICORE_TOPOLOGY_AP_PREFLIGHT_MARKER, MULTICORE_TOPOLOGY_BARRIER_MARKER,
    MULTICORE_TOPOLOGY_BOOTSTRAP_MARKER, MULTICORE_TOPOLOGY_DRIVER_SERVICE_MARKER,
