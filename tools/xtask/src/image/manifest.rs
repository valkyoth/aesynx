...
use super::smoke::{
    ...
    FAULT_INTERRUPTS_MARKER, FAULT_RFLAGS_MARKER, FRAME_ALLOCATOR_MARKER,
    FRAME_ALLOCATOR_STATUS_MARKER, HEAP_DOUBLE_FREE_MARKER, HEAP_INVALID_FREE_MARKER, HEAP_MARKER,
