...
use super::smoke::{
    BOOT_DIAGNOSTIC_MARKER, BOOTINFO_MARKER, CPU_HARDENING_MARKER, CPU_HARDENING_STATUS_MARKER,
    ...
    KERNEL_STACK_GUARD_STATUS_MARKER, KERNEL_STACK_PAGES_MARKER, MEMORY_MAP_MARKER,
