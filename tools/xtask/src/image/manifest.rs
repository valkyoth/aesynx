...
use super::smoke::{
    ...
    CAP_TABLE_MARKER, CAP_TABLE_STATUS_MARKER, CPU_HARDENING_MARKER, CPU_HARDENING_STATUS_MARKER,
    ...
    FRAME_ALLOCATOR_MARKER, FRAME_ALLOCATOR_STATUS_MARKER, HEAP_DOUBLE_FREE_MARKER,
    ...
    KERNEL_CR3_ACTIVE_MARKER, KERNEL_CR3_MARKER, KERNEL_STACK_GUARD_MARKER,
    ...
    PANIC_REGISTERS_MARKER, SERIAL_MARKER, SERVICE_QUEUE_MARKER, SERVICE_QUEUE_STATUS_MARKER,
    SLEEP_MARKER, SmokeKind, TASK_MODEL_MARKER, TASK_MODEL_STATUS_MARKER, TIMER_DELAYED_LOG_MARKER,
