...
use super::smoke::{
    ...
    PAGE_TABLE_FLAGS_MARKER, PAGE_TABLE_KERNEL_CANDIDATE_MARKER, PAGE_TABLE_KERNEL_ONLY_MARKER,
    ...
    PAGE_TABLE_STATUS_MARKER, PAGE_TABLE_UNMAPPED_RANGE_MARKER, PAGE_TABLE_USER_CANDIDATE_MARKER,
