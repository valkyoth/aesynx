...
use super::smoke::{
    ...
    BOOTINFO_MARKER, CAP_AUDIT_MARKER, CAP_AUDIT_STATUS_MARKER, CAP_TABLE_MARKER,
    CAP_TABLE_STATUS_MARKER, COOPERATIVE_SCHED_MARKER, COOPERATIVE_SCHED_STATUS_MARKER,
