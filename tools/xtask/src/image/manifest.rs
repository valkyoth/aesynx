...
use super::smoke::{
    ...
    FRAME_ALLOCATOR_MARKER, FRAME_ALLOCATOR_STATUS_MARKER, IRQ_SETUP_MARKER,
    KERNEL_CR3_ACTIVE_MARKER, KERNEL_CR3_MARKER, MEMORY_MAP_MARKER, MEMORY_RESERVED_MARKER,
