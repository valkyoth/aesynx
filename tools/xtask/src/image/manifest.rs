...
use super::smoke::{
    ...
    CPU_HARDENING_IBPB_MARKER, CPU_HARDENING_IBRS_MARKER, CPU_HARDENING_MARKER,
    CPU_HARDENING_SSBD_MARKER, CPU_HARDENING_STATUS_MARKER, CPU_HARDENING_STIBP_MARKER,
    CPU_SETUP_MARKER, ENTROPY_POLICY_DRBG_SELF_TEST_MARKER, ENTROPY_POLICY_FALLBACK_MARKER,
    ENTROPY_POLICY_GENERATION_MARKER, ENTROPY_POLICY_HARDWARE_MARKER, ENTROPY_POLICY_MARKER,
    ENTROPY_POLICY_RANDOM_TOKEN_MARKER, ENTROPY_POLICY_SELF_TEST_MARKER,
    ...
    HEAP_STRESS_MARKER, IRQ_SETUP_MARKER, KERNEL_CR3_ACTIVE_MARKER, KERNEL_CR3_MARKER,
    KERNEL_STACK_GUARD_MARKER, KERNEL_STACK_GUARD_STATUS_MARKER, KERNEL_STACK_PAGES_MARKER,
    MEMORY_CAP_MARKER, MEMORY_CAP_STATUS_MARKER, MEMORY_MAP_MARKER, MEMORY_RESERVED_MARKER,
    MEMORY_TOTAL_MARKER, MEMORY_USABLE_MARKER, MULTICORE_TOPOLOGY_AP_DISPATCH_TOKEN_BLOCKED_MARKER,
