...
use super::smoke::{
    ...
    PAGE_TABLE_AUDIT_MARKER, PAGE_TABLE_CHECKED_STATUS_MARKER, PAGE_TABLE_CHECKED_TRANSLATE_MARKER,
    ...
    PAGE_TABLE_UNMAPPED_RANGE_MARKER, PAGE_TABLE_USER_RANGE_MARKER,
