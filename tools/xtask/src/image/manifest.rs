...
use super::smoke::{
    ...
    PAGE_TABLE_KERNEL_SPACE_RANGE_MARKER, PAGE_TABLE_LOCAL_RANGE_MARKER, PAGE_TABLE_LOOKUP_MARKER,
    ...
    PAGE_TABLE_WRITE_PROTECTED_RANGE_MARKER, PANIC_MARKER, SERIAL_MARKER, SLEEP_MARKER, SmokeKind,
