...
use super::smoke::{
    ...
    CAP_IPC_AUDIT_MARKER, CAP_IPC_GRANT_MESSAGE_MARKER, CAP_IPC_MARKER,
    CAP_IPC_RECEIVER_READ_MARKER, CAP_IPC_RECEIVER_REVOKED_MARKER,
    CAP_IPC_RECEIVER_WRITE_DENIED_MARKER, CAP_IPC_REGISTRY_EPOCH_MARKER,
    CAP_IPC_REVOKE_MESSAGE_MARKER, CAP_IPC_SENDER_GRANT_DENIED_MARKER, CAP_IPC_STATUS_MARKER,
    ...
    COOPERATIVE_SCHED_STATUS_MARKER, CPU_HARDENING_ARCH_CAPABILITIES_MARKER,
    CPU_HARDENING_IBPB_ATTEMPTED_MARKER, CPU_HARDENING_IBPB_MARKER, CPU_HARDENING_IBRS_MARKER,
    CPU_HARDENING_MARKER, CPU_HARDENING_SSBD_MARKER, CPU_HARDENING_STATUS_MARKER,
    CPU_HARDENING_STIBP_MARKER, CPU_SETUP_MARKER, ENTROPY_POLICY_DRBG_SELF_TEST_MARKER,
    ...
    FRAME_ALLOCATOR_MARKER, FRAME_ALLOCATOR_STATUS_MARKER, HEAP_ACCOUNTING_OVERFLOW_MARKER,
    HEAP_CORRUPT_FREE_LIST_MARKER, HEAP_DOUBLE_FREE_MARKER, HEAP_INVALID_FREE_MARKER, HEAP_MARKER,
    HEAP_PAGE_RUN_MARKER, HEAP_SLAB_CLASSES_MARKER, HEAP_SLAB_REUSE_MARKER, HEAP_STATUS_MARKER,
    HEAP_STRESS_MARKER, IPC_PINGPONG_BACKPRESSURE_MARKER, IPC_PINGPONG_MARKER,
    IPC_PINGPONG_PAIRWISE_MARKER, IPC_PINGPONG_RELEASE_ACQUIRE_MARKER, IPC_PINGPONG_STATUS_MARKER,
    ...
    MEMORY_USABLE_MARKER, MULTICORE_TOPOLOGY_AP_DISPATCH_TOKEN_BLOCKED_MARKER,
    ...
    MULTICORE_TOPOLOGY_DRIVER_SERVICE_MARKER, MULTICORE_TOPOLOGY_HARDWARE_ONLINE_MARKER,
    MULTICORE_TOPOLOGY_IDLE_MARKER, MULTICORE_TOPOLOGY_MARKER, MULTICORE_TOPOLOGY_QEMU_SMP_MARKER,
...
use super::{KERNEL_PROFILE, KERNEL_TARGET, QEMU_SMP_CPUS};
...
fn manifest_path_field(name: &str, path: &Path) -> Result<String, String> {
    manifest_text_field(name, &path.display().to_string())
}
