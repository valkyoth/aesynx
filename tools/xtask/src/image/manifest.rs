...
use super::smoke::{
    AI_POLICY_HEURISTIC_DISABLED_MARKER, AI_POLICY_HEURISTIC_ENABLED_MARKER,
    AI_POLICY_HEURISTIC_SCORE_MARKER, AI_POLICY_MARKER, AI_POLICY_METADATA_GATE_MARKER,
    AI_POLICY_STATUS_MARKER, BOOT_DIAGNOSTIC_MARKER, BOOTINFO_MARKER, CAP_AUDIT_MARKER,
    CAP_AUDIT_STATUS_MARKER, CAP_TABLE_MARKER, CAP_TABLE_STATUS_MARKER, COOPERATIVE_SCHED_MARKER,
