...
use super::smoke::{
    ...
    PAGE_TABLE_KERNEL_ONLY_MARKER, PAGE_TABLE_KERNEL_RANGE_MARKER, PAGE_TABLE_LOCAL_RANGE_MARKER,
    PAGE_TABLE_LOOKUP_MARKER, PAGE_TABLE_MAPPED_RANGE_MARKER, PAGE_TABLE_MARKER,
    ...
    PAGE_TABLE_USER_RANGE_MARKER, PAGE_TABLE_VISIT_MARKER, PAGE_TABLE_WRITE_PROTECTED_RANGE_MARKER,
    PANIC_MARKER, SERIAL_MARKER, SLEEP_MARKER, SmokeKind, TIMER_DELAYED_LOG_MARKER, TIMER_MARKER,
