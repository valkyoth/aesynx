use super::smoke::{
    ...
    AI_POLICY_METADATA_GATE_MARKER, AI_POLICY_STATUS_MARKER, BOOT_DIAGNOSTIC_MARKER,
    BOOTINFO_FAIL_MARKER, BOOTINFO_MARKER, CAP_AUDIT_FAIL_MARKER, CAP_AUDIT_MARKER,
    CAP_AUDIT_STATUS_MARKER, CAP_TABLE_FAIL_MARKER, CAP_TABLE_MARKER, CAP_TABLE_STATUS_MARKER,
    CONCURRENCY_FAIL_MARKER, CONCURRENCY_IRQ_LOCK_MARKER, CONCURRENCY_IRQ_MARKER,
    CONCURRENCY_LOCK_MARKER, CONCURRENCY_MARKER, CONCURRENCY_NESTED_IRQ_MARKER,
    CONCURRENCY_ORDER_MARKER, CONCURRENCY_STATUS_MARKER, COOPERATIVE_SCHED_FAIL_MARKER,
