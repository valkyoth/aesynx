use super::smoke::{
    AI_POLICY_FAIL_MARKER, AI_POLICY_HEURISTIC_DISABLED_MARKER, AI_POLICY_HEURISTIC_ENABLED_MARKER,
    AI_POLICY_HEURISTIC_SCORE_MARKER, AI_POLICY_MARKER, AI_POLICY_METADATA_GATE_MARKER,
    AI_POLICY_STATUS_MARKER, BOOT_DIAGNOSTIC_MARKER, BOOTINFO_FAIL_MARKER, BOOTINFO_MARKER,
    CAP_AUDIT_FAIL_MARKER, CAP_AUDIT_MARKER, CAP_AUDIT_STATUS_MARKER, CAP_TABLE_FAIL_MARKER,
    CAP_TABLE_MARKER, CAP_TABLE_STATUS_MARKER, COOPERATIVE_SCHED_FAIL_MARKER,
    COOPERATIVE_SCHED_MARKER, COOPERATIVE_SCHED_STATUS_MARKER, CPU_HARDENING_FAIL_MARKER,
    ...
    HEAP_CORRUPT_FREE_LIST_MARKER, HEAP_DOUBLE_FREE_MARKER, HEAP_FAIL_MARKER,
    HEAP_INVALID_FREE_MARKER, HEAP_MARKER, HEAP_PAGE_RUN_MARKER, HEAP_SLAB_CLASSES_MARKER,
    HEAP_SLAB_REUSE_MARKER, HEAP_STATUS_MARKER, HEAP_STRESS_MARKER, IRQ_SETUP_MARKER,
    KERNEL_CR3_ACTIVE_MARKER, KERNEL_CR3_FAIL_MARKER, KERNEL_CR3_MARKER, KERNEL_STACK_GUARD_MARKER,
    KERNEL_STACK_GUARD_STATUS_MARKER, KERNEL_STACK_PAGES_MARKER, MEMORY_CAP_FAIL_MARKER,
    MEMORY_CAP_MARKER, MEMORY_CAP_STATUS_MARKER, MEMORY_MAP_FAIL_MARKER, MEMORY_MAP_MARKER,
...
fn qemu_markers_track_current_contracts() {
    ...
    assert_eq!(AI_POLICY_HEURISTIC_SCORE_MARKER, "heuristic_score=");
    assert_eq!(
