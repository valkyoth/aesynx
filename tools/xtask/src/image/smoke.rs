#[path = "smoke_contract.rs"]
mod smoke_contract;
#[path = "smoke_marker_text.rs"]
mod smoke_marker_text;
#[path = "smoke_match.rs"]
mod smoke_match;
...
pub const IPC_PINGPONG_BACKPRESSURE_MARKER: &str = "ipc_backpressure_ok=true";
pub const IPC_PINGPONG_FAIL_MARKER: &str = "[TEST] ipc-pingpong=fail";
pub const IPC_PINGPONG_MARKER: &str = "[TEST] ipc-pingpong=ok";
pub const IPC_PINGPONG_PAIRWISE_MARKER: &str = "ipc_pairwise_route_ok=true";
pub const IPC_PINGPONG_RELEASE_ACQUIRE_MARKER: &str = "ipc_release_acquire_ok=true";
pub const IPC_PINGPONG_STATUS_MARKER: &str = "ipc-pingpong ping_seq=";
pub const CAP_IPC_AUDIT_MARKER: &str = "cap_ipc_grant_audit_seen=true";
pub const CAP_IPC_FAIL_MARKER: &str = "[TEST] cap-ipc=fail";
pub const CAP_IPC_GRANT_MESSAGE_MARKER: &str = "cap_ipc_grant_message_ok=true";
pub const CAP_IPC_MARKER: &str = "[TEST] cap-ipc=ok";
pub const CAP_IPC_RECEIVER_READ_MARKER: &str = "cap_ipc_receiver_read_ok=true";
pub const CAP_IPC_RECEIVER_REVOKED_MARKER: &str = "cap_ipc_receiver_revoked=true";
pub const CAP_IPC_RECEIVER_WRITE_DENIED_MARKER: &str = "cap_ipc_receiver_write_denied=true";
pub const CAP_IPC_REGISTRY_EPOCH_MARKER: &str = "cap_ipc_registry_epoch_bumped=true";
pub const CAP_IPC_REVOKE_MESSAGE_MARKER: &str = "cap_ipc_revoke_message_ok=true";
pub const CAP_IPC_SENDER_GRANT_DENIED_MARKER: &str = "cap_ipc_sender_missing_grant_denied=true";
pub const CAP_IPC_STATUS_MARKER: &str = "cap-ipc grant_seq=";
