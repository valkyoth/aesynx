...
pub const IPC_PINGPONG_BACKPRESSURE_MARKER: &str = "backpressure_ok=true";
pub const IPC_PINGPONG_FAIL_MARKER: &str = "[TEST] ipc-pingpong=fail";
pub const IPC_PINGPONG_MARKER: &str = "[TEST] ipc-pingpong=ok";
pub const IPC_PINGPONG_PAIRWISE_MARKER: &str = "pairwise_route_ok=true";
pub const IPC_PINGPONG_RELEASE_ACQUIRE_MARKER: &str = "release_acquire_ok=true";
