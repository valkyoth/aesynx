...
pub const AI_POLICY_HEURISTIC_CORE_MARKER: &str = "heuristic_core=<redacted>";
...
pub const AI_POLICY_HEURISTIC_SCORE_MARKER: &str = "heuristic_score=<redacted>";
...
pub const MULTICORE_TOPOLOGY_AP_PREFLIGHT_MARKER: &str = "ap_preflight_ok=true";
pub const MULTICORE_TOPOLOGY_AP_EXECUTION_BLOCKED_MARKER: &str = "ap_execution_blocked_ok=true";
pub const MULTICORE_TOPOLOGY_AP_DISPATCH_TOKEN_BLOCKED_MARKER: &str =
    "ap_dispatch_token_blocked_ok=true";
...
pub const MULTICORE_TOPOLOGY_STATE_TABLE_MARKER: &str = "state_table_ok=true";
pub const MULTICORE_TOPOLOGY_STARTUP_EVIDENCE_MARKER: &str = "startup_evidence_ok=true";
...
pub const CONCURRENCY_FAIL_MARKER: &str = "[TEST] concurrency=fail";
pub const CONCURRENCY_IRQ_MARKER: &str = "irq_guard_ok=true";
pub const CONCURRENCY_IRQ_LOCK_MARKER: &str = "irq_lock_ok=true";
pub const CONCURRENCY_LOCK_MARKER: &str = "early_lock_ok=true";
pub const CONCURRENCY_MARKER: &str = "[TEST] concurrency=ok";
pub const CONCURRENCY_NESTED_IRQ_MARKER: &str = "nested_irq_guard_ok=true";
pub const CONCURRENCY_ORDER_MARKER: &str = "lock_order_ok=true";
pub const CONCURRENCY_STATUS_MARKER: &str = "concurrency irq_guard_ok=true";
...
pub const CPU_HARDENING_IBRS_MARKER: &str = "ibrs=";
pub const CPU_HARDENING_IBPB_MARKER: &str = "ibpb_supported=";
pub const CPU_HARDENING_IBPB_ATTEMPTED_MARKER: &str = "ibpb_attempted=";
pub const CPU_HARDENING_STIBP_MARKER: &str = "stibp=";
pub const CPU_HARDENING_SSBD_MARKER: &str = "ssbd=";
pub const CPU_HARDENING_ARCH_CAPABILITIES_MARKER: &str = "arch_capabilities=";
...
pub const ENTROPY_POLICY_DRBG_SELF_TEST_MARKER: &str = "drbg_self_test=false";
...
pub const HEAP_ACCOUNTING_OVERFLOW_MARKER: &str = "accounting_overflow_detected=false";
