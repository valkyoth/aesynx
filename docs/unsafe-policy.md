...
Tests/evidence: host unit tests cover the admitted MSR set, NX-required policy, optional feature gating, strict NX/SMEP/SMAP/UMIP policy rejection, and redacted status projection; cargo xtask qemu observes cpu-hardening nx=<bool> wp=<bool> smep=<bool> smap=<bool> umip=<bool> and [TEST] cpu-hardening=ok
