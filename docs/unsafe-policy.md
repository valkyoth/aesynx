...
Tests/evidence: host unit tests cover the admitted MSR set, NX-required policy, optional feature gating, strict NX/SMEP/SMAP/UMIP/IBRS/STIBP/SSBD/ARCH_CAPABILITIES policy rejection, SPEC_CTRL read-back verification, and redacted status projection; cargo xtask qemu observes cpu-hardening nx=<bool> wp=<bool> smep=<bool> smap=<bool> umip=<bool> ibrs=<bool> ibpb_supported=<bool> stibp=<bool> ssbd=<bool> arch_capabilities=<bool> and [TEST] cpu-hardening=ok
