...
For 1.0, `ObjectId` can be generated by a monotonic boot-local allocator plus random/entropy bits if available. The content hash is still calculated for immutable payloads.
