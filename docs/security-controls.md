...
| Early diagnostics | Panic output includes boot phase, early core, source location, message, and QEMU panic marker | Active candidate | `aesynx-kernel::diagnostics`, `cargo xtask qemu --panic-smoke` |
