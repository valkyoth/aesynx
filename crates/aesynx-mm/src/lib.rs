...
pub use page_table::{
    ...
    PageRangeMapping, PageTableError, PageTableMapper, PageTableStatus, ProtectOutcome,
    ProtectRangeOutcome, TlbFlush, UnmapOutcome, UnmapRangeOutcome, X86_64PageTableEntry,
};
