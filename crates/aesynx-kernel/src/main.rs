            ...
            match aesynx_kernel::boot_summary(&info) {
                Ok(summary) => {
                    ...
                    match page_table_smoke::run() {
                        Ok(status) => {
                            aesynx_arch_x86_64::serial_println!(
                                "page-table total_tables={} used_tables={} mapped_before_unmap={} mapped_after_unmap={} translate_offset_ok={} mapping_lookup_ok={} protect_ok={} protect_range_ok={} range_lookup_ok={} unmapped_range_ok={} audit_ok={} visit_ok={} reclaim_ok={} range_ok={} flush_page={}",
                                status.total_tables,
                                status.used_tables,
