...
pub use smoke_modules::{
    ai_policy_smoke, amp_core_smoke, capability_ipc_smoke, capability_smoke, entropy_smoke,
    ipc_pingpong_smoke, multicore_topology_smoke, scheduler_telemetry_smoke,
